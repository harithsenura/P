  ...
  return (
    <section id="about" ref={secRef}>
      ...
      <div className="about-layout">
        ...
        <div>
          <p className="about-bio">A <em>Fullstack Software Engineer</em> passionate about crafting end-to-end digital products — scalable web apps, native Android &amp; iOS apps, and seamless cross-platform experiences. <em>Currently pursuing two degrees in parallel: Software Engineering at SLIIT and Cybersecurity at ESOFT Metro Campus.</em></p>
