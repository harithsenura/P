...
export const metadata: Metadata = {
  ...
  description: 'Harith Divarathna is a Fullstack Software Engineer specializing in scalable web and mobile products. Expert in Next.js, React Native, Node.js, and Cybersecurity.',
  keywords: [
    'Harith Divarathna',
    'Harith',
    'Divarathna',
